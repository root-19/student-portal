...
<div class="bg-white mt-10 mx-auto rounded-lg shadow-lg p-6 w-full max-w-1xl">
    ...
    <div id="profileView" class="space-y-4">
        <div class="flex items-center space-x-4">
            <div class="w-16 h-16 bg-amber-500 text-black rounded-full flex items-center justify-center font-bold text-xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-black text-sm">
